...
public class EventStreamsProducer {
    ...
    private final Logger logger = Logger.getLogger(EventStreamsProducer.class.getName());
    ...
    private KafkaProducer<String, String> createProducer(String brokerList) {
        ...
        if (SASL_JAAS_CONFIG == null)
            SASL_JAAS_CONFIG = "org.apache.kafka.common.security.plain.PlainLoginModule required username=\"" + USERNAME + "\" password=\"" + API_KEY + "\";";
        ...
        try {
            ...
            logger.warning("KafkaProducer properties: " + stringWriter);
            throw kafkaError;
        }
        return kafkaProducer;
    }

    public RecordMetadata produce(String message) throws InterruptedException, ExecutionException {
