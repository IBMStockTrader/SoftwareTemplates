...
/** JSON-B POJO class representing an ${{ values.name }} JSON object and an JNoSQL Entity*/
@Entity
@Getter
@Setter
@EqualsAndHashCode
@ToString
public class ${{ values.name }}Entity {
    ...
    public ${{ values.name }}Entity() { //default constructor
    ...
    public ${{ values.name }}Entity(String initialOwner) { //primary key constructor
        this();
        setOwner(initialOwner);
    }

    public ${{ values.name }}Entity(String initialOwner, String initialLoyalty, double initialBalance, double initialCommissions,
    ...
    public ${{ values.name }}Entity(String id, String initialOwner, String initialLoyalty, double initialBalance, double initialCommissions,
                   int initialFree, String initialSentiment, double initialNextCommission) {
        setId(id);
        setOwner(initialOwner);
        setLoyalty(initialLoyalty);
