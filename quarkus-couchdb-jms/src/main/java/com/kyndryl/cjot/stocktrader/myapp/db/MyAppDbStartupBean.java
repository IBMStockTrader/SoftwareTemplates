...
/**
 * This class initializes the connection to a CouchDB/CloudantDB,
 * creates any indexes in CouchDB/Cloudant that are needed by JNoSQL,
 * and can do any other initialization at Startup.
 *
 * You can use this as a template for any other components
 */
@ApplicationScoped
public class MyAppDbStartupBean {
    private static final Logger logger = Logger.getLogger(MyAppDbStartupBean.class.getName());
